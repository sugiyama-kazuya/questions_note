                ...
                <div class="h-90">
                    <ValidationObserver v-slot="{ handleSubmit }">
                        <form
                            class="pb-8"
                            id="createForm"
                            @submit.prevent="handleSubmit(newProblemCreate)"
                        >
                            <div class="bg-gray-200 p-3 mb-3">
                                <label
                                    class="px-3 block text-gray-700 font-bold mb-2"
                                    for="problem"
                                    >問題</label
                                >
                                <ValidationProvider
                                ...
                                <div
                                    class="flex justify-between px-3 items-center"
                                >
                                    <p class="m-0">画像を選択</p>
                            ...
                            >
                                <transition name="validateError">
                                    <p
                                        v-if="errors[0]"
                                        class="text-red-500 text-xs italic pl-3"
                                    >
                                        {{ errors[0] }}
                                    </p>
                                </transition>
        ...
        <transition name="new-problem">
            <CenterModal v-if="addNewProblemModal">
                <template>
                    ...
                    <form @submit.prevent="addNewProblem">
                        <div
...
export default {
    ...
    methods: {
        ...
        cancel() {
            ...
            this.$store.commit(
                "createForm/setCreateExerciseBooksNameErr",
                null
            );
